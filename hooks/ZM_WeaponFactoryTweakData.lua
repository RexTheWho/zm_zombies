...
function WeaponFactoryTweakData:_define_sights()
    ...
    self.parts.wpn_fps_upg_o_acog.stance_mod.wpn_fps_ass_fal_upg_primary = self.parts.wpn_fps_upg_o_acog.stance_mod.wpn_fps_ass_fal
    self.parts.wpn_fps_upg_o_acog.stance_mod.wpn_fps_ass_fal_upg_secondary = self.parts.wpn_fps_upg_o_acog.stance_mod.wpn_fps_ass_fal
